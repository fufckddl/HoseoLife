        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          ...
          {!contact.is_answered && (
            <View style={styles.statusChangeContainer}>
              <Text style={styles.statusChangeLabel}>상태 변경</Text>
              <View style={styles.statusButtons}>
                <TouchableOpacity 
                  style={[styles.statusButton, contact.status === '대기중' && styles.statusButtonActive]}
                  onPress={() => handleStatusChange('대기중')}
                >
                  <Text style={[styles.statusButtonText, contact.status === '대기중' && styles.statusButtonTextActive]}>대기중</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                  style={[styles.statusButton, contact.status === '처리중' && styles.statusButtonActive]}
                  onPress={() => handleStatusChange('처리중')}
                >
                  <Text style={[styles.statusButtonText, contact.status === '처리중' && styles.statusButtonTextActive]}>처리중</Text>
                </TouchableOpacity>
              </View>
            </View>
          )}
