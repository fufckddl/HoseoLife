...
export default function FreshmanBoardScreen() {
  ...
  const handleCreatePost = () => {
    router.push('/posts/create-freshman-post');
  };

  const handleSearch = () => {
    router.push('/pages/search?category=새내기');
  };
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>새내기 게시판</Text>
